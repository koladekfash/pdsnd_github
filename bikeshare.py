...
def choice(prompt, choices=('y', 'n')):
    ...
    while True:
        ...
        prompt = ("\nPlease mind the formatting and "
...
def get_filters():
    ...
    while True:
        city = choice("\nFor what city(ies) do you want do select data, "
                      ...
                      "to list the names.\n>", CITY_DATA.keys())
        month = choice("\nFrom January to June, what month(s) do you "
                       "want do filter data from? Use commas to list the names.\n>",
                       months)
        day = choice("\nFor what weekday(s) do you want do filter "
...
def raw_data(df, mark_place):
    ...
    while True:
        for i in range(mark_place, len(df.index)):
            ...
            if choice("Do you want to keep on printing raw data?"
                      "\n\n[y]Yes\n[n]No\n\n>") == 'y':
                continue
            else:
                break
